...
# google_play_sentiment documentation build
...
from google_play_sentiment import __version__ as release

# -- Project information -----------------------------------------------------

project = "google_play_sentiment"
author = "Kedro"
...
htmlhelp_basename = "google_play_sentimentdoc"
...
latex_documents = [
    (
        master_doc,
        "google_play_sentiment.tex",
        "google_play_sentiment Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google_play_sentiment",
        "Project google_play_sentiment codebase.",
        "Data-Science",
    )
]
